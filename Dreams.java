	...
	public void ariDream(){
		...
		if(choice.equals("kiss")){
			...
			if(choice.equals("punch")){
				...
				System.out.println("        Did i call her an ambulance? or did i dab on her??      'doctor'  'suck it up' ");
				System.out.println("        ");
				choice = bob.next();
				...
				else if(choice.equals("suck it up")){
					System.out.println("        ");
					System.out.println("        ");
		...
		if(choice.equals("punch")){
			...
			if(choice.equals("soyboy")){
				...
				if(choice.equals("punch")){
					...
					blip = bob.next();
					System.out.println("        ");
					System.out.println("        and just like that she was gone... i swore to stop being a beta male. And she went off to BLING SHING");
